...
const MOCK_TOKENS = [
  { id: 'bitcoin', name: 'Bitcoin', symbol: 'BTC', current_price: 45280.50, image: '', market_cap_rank: 1, price_change_percentage_24h: 2.5 },
  { id: 'ethereum', name: 'Ethereum', symbol: 'ETH', current_price: 2580.75, image: '', market_cap_rank: 2, price_change_percentage_24h: 1.8 },
  { id: 'cardano', name: 'Cardano', symbol: 'ADA', current_price: 1.05, image: '', market_cap_rank: 4, price_change_percentage_24h: 0.5 },
  { id: 'solana', name: 'Solana', symbol: 'SOL', current_price: 180.25, image: '', market_cap_rank: 5, price_change_percentage_24h: 3.2 },
  { id: 'polkadot', name: 'Polkadot', symbol: 'DOT', current_price: 7.85, image: '', market_cap_rank: 12, price_change_percentage_24h: -0.8 },
  { id: 'ripple', name: 'XRP', symbol: 'XRP', current_price: 2.15, image: '', market_cap_rank: 7, price_change_percentage_24h: 1.2 },
  { id: 'litecoin', name: 'Litecoin', symbol: 'LTC', current_price: 640.50, image: '', market_cap_rank: 20, price_change_percentage_24h: 4.1 },
  { id: 'dogecoin', name: 'Dogecoin', symbol: 'DOGE', current_price: 0.32, image: '', market_cap_rank: 10, price_change_percentage_24h: 2.9 },
  { id: 'uniswap', name: 'Uniswap', symbol: 'UNI', current_price: 18.50, image: '', market_cap_rank: 25, price_change_percentage_24h: -1.5 },
  { id: 'chainlink', name: 'Chainlink', symbol: 'LINK', current_price: 28.75, image: '', market_cap_rank: 22, price_change_percentage_24h: 3.1 },
  { id: 'avalanche-2', name: 'Avalanche', symbol: 'AVAX', current_price: 95.20, image: '', market_cap_rank: 15, price_change_percentage_24h: 2.7 },
  { id: 'polygon', name: 'Polygon', symbol: 'MATIC', current_price: 0.95, image: '', market_cap_rank: 16, price_change_percentage_24h: 1.3 },
  { id: 'cosmos', name: 'Cosmos', symbol: 'ATOM', current_price: 11.50, image: '', market_cap_rank: 24, price_change_percentage_24h: 0.9 },
  { id: 'vechain', name: 'VeChain', symbol: 'VET', current_price: 0.045, image: '', market_cap_rank: 35, price_change_percentage_24h: -0.3 },
  { id: 'iota', name: 'IOTA', symbol: 'IOTA', current_price: 0.38, image: '', market_cap_rank: 40, price_change_percentage_24h: 2.1 },
  { id: 'eos', name: 'EOS', symbol: 'EOS', current_price: 2.05, image: '', market_cap_rank: 32, price_change_percentage_24h: 1.7 },
  { id: 'monero', name: 'Monero', symbol: 'XMR', current_price: 185.50, image: '', market_cap_rank: 28, price_change_percentage_24h: 3.4 },
  { id: 'zcash', name: 'Zcash', symbol: 'ZEC', current_price: 82.25, image: '', market_cap_rank: 45, price_change_percentage_24h: 2.8 },
  { id: 'tezos', name: 'Tezos', symbol: 'XTZ', current_price: 1.85, image: '', market_cap_rank: 38, price_change_percentage_24h: 1.4 },
  { id: 'neo', name: 'NEO', symbol: 'NEO', current_price: 22.50, image: '', market_cap_rank: 50, price_change_percentage_24h: -0.5 },
];
